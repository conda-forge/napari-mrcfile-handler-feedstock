About napari-mrcfile-handler-feedstock
======================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/napari-mrcfile-handler-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15364&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/napari-mrcfile-handler-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `napari-mrcfile-handler` can be installed with `conda`:
...
```
mamba install napari-mrcfile-handler
```

It is possible to list all of the versions of `napari-mrcfile-handler` available on your platform with `conda`:
...
```
mamba search napari-mrcfile-handler --channel conda-forge
```
...
mamba repoquery search napari-mrcfile-handler --channel conda-forge

# List packages depending on `napari-mrcfile-handler`:
mamba repoquery whoneeds napari-mrcfile-handler --channel conda-forge

# List dependencies of `napari-mrcfile-handler`:
mamba repoquery depends napari-mrcfile-handler --channel conda-forge
```
